...
export function setMultiple<T1, T2>(atoms: [Atom<T1>, Atom<T2>], vals: [T1, T2], key?: any): void;

export function setMultiple<T1, T2, T3>(atoms: [Atom<T1>, Atom<T2>, Atom<T3>], vals: [T1, T2, T3], key?: any): void;
